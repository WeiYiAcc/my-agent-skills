...
**Usage:**
```bash
bash /home/weiyiacc/.pi/agent/skills/visual-explainer/scripts/share.sh <html-file>
```

**Example:**
```bash
bash /home/weiyiacc/.pi/agent/skills/visual-explainer/scripts/share.sh ~/.agent/diagrams/my-diagram.html
